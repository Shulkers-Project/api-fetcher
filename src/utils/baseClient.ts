...
export abstract class BaseAPIClient {
   ...
   * @protected
   */
  protected async makeRequest<T>(endpoint: string, searchParams?: Record<string, any>): Promise<T> {
    try {
   ...
   * @protected
   */
  protected async makePostRequest<T>(endpoint: string, body?: any, searchParams?: Record<string, any>): Promise<T> {
    try {
   ...
   * @protected
   */
  protected async makeRawRequest(url: string): Promise<Response> {
    try {
