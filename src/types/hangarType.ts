 ...
 */
export enum HangarVersionChannel {
  RELEASE = "Release",
  SNAPSHOT = "Snapshot",
  ALPHA = "Alpha",
  BETA = "Beta",
...
export class HangarError extends Error {
  public readonly code: HangarErrorCode;
  public readonly context?: Record<string, any>;

  constructor(
    code: HangarErrorCode,
    message: string,
