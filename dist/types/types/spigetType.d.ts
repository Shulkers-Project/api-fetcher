export declare enum SpigetSearchField {
    NAME = "name",
    TAG = "tag"
}
export declare enum SpigetVersionMethod {
    ANY = "any",
    ALL = "all"
}
/**
 ...
 */
export declare enum SpigetErrorCode {
 ...
 */
export declare class SpigetError extends Error {
    code: SpigetErrorCode;
     ...
     */
    constructor(code: SpigetErrorCode, message: string, details?: any | undefined);
}
...
//# sourceMappingURL=spigetType.d.ts.map